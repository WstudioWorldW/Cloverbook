<template>
    <div class="buybook">
        <div class="container__big">
            <div class="buybook__container">
                <div class="questions__container">
                    <h2 class="title">
                        <router-link to="" class="title__link">Купить книгу</router-link>
                        <span class="icons__title"><i class="fal fa-chevron-right icon__title"></i></span>
                    </h2>
                </div>
            </div>
            <div class="container">
                <div class="buybook__content">
                    <div class="buybook__content-cover">
                    ...
                    <div class="buybook__content-info">
                        ...
                        <div class="buybook__content-info-btn"><router-link to="" class="buybook__content-info-btn-b">Купить</router-link></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        &-info {
            ...
            &-btn {
                ...
                &-b {
                    ...
                    line-height: 54px;
                    color: #FFFFFF;
                    background: rgba(155, 195, 255, 0.85);
                    border-radius: 49px;
                    padding: 15px 50px;
